        ...
        <header className="container mx-auto px-4 py-6">
          <nav className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Link href="/demo">
                <Button variant="outline" className="border-2 border-indigo-100 text-indigo-600 hover:bg-indigo-50 font-medium">
                  🚀 Coba Demo
                </Button>
              </Link>
              <Link href="/login">
        ...
        <main className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link href="/demo">
                <Button size="lg" variant="outline" className="text-lg px-8 py-6 w-full sm:w-auto border-2 border-primary text-primary hover:bg-primary/5">
          ...
          <div className="text-center mt-16 pb-16">
            <p className="text-gray-600 mb-6">Siap mengatur keuangan Anda?</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/login">
                <Button size="lg" variant="default" className="px-8 w-full sm:w-auto">
                  Daftar Sekarang
                </Button>
              </Link>
              <Link href="/demo">
                <Button size="lg" variant="outline" className="px-8 w-full sm:w-auto border-2">
                  Coba Demo
                </Button>
              </Link>
            </div>
