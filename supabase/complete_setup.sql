-- =====================================================
-- COMPLETE DATABASE SETUP (CLEANUP + CREATE)
-- =====================================================
-- This script will:
-- 1. Drop all existing tables, functions, triggers, types
-- 2. Create fresh schema with all tables
-- 3. Setup RLS policies
-- 4. Create triggers for auto-profile creation and budget alerts

-- =====================================================
-- STEP 1: CLEANUP (DROP EVERYTHING)
-- =====================================================

-- Drop all triggers first (use DO block to handle if table doesn't exist)
DO $$
BEGIN
...
DO $$
BEGIN
    DROP TRIGGER IF EXISTS create_user_default_categories ON profiles;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
...
-- 1. Profile created when they sign up
-- 2. 13 default categories (8 expense + 5 income)
-- 3. Budget alerts when spending exceeds threshold
